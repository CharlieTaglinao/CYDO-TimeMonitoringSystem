<div class="modal fade" id="customOfficeExportPDFModal" tabindex="-1" aria-labelledby="customOfficeExportPDFModalLabel"
    aria-hidden="true">
...
<script>
    const exportForm = document.getElementById('customOfficeFormPDF');
    ...
    if (applyButton) {
        applyButton.addEventListener('click', async () => {
            ...
            // Hide the modal
            const modal = document.getElementById('customOfficeExportPDFModal');
            if (modal) {
