...
<div id="sidebar" class="p-3" style="width: 330px; height: auto; min-height: 100vh;">
    ...
    <nav class="nav flex-column">
        ...
        <!-- Management -->
        <div class="nav-item">
            <a class="nav-link dropdown-toggle" data-bs-toggle="collapse" href="#managementSubmenu" role="button" aria-expanded="false" aria-controls="managementSubmenu">
                Management
            </a>
            <div class="collapse" id="managementSubmenu">
                <nav class="nav flex-column ms-3">
                    <!-- Members -->
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="collapse" href="#membersSubmenu" role="button" aria-expanded="false" aria-controls="membersSubmenu">
                            Members
                        </a>
                    ...
                    <!-- Accounts -->
                    <div class="nav-item">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="collapse" href="#accountsSubmenu" role="button" aria-expanded="false" aria-controls="accountsSubmenu">
                            Accounts
                        </a>
        ...
        <!-- Monitoring -->
        <div class="nav-item">
            <a class="nav-link dropdown-toggle" data-bs-toggle="collapse" href="#monitoringSubmenu" role="button" aria-expanded="false" aria-controls="monitoringSubmenu">
                Monitoring
            </a>
        ...
        <!-- Settings -->
        <div class="nav-item">
            <a class="nav-link dropdown-toggle" data-bs-toggle="collapse" href="#settingsSubmenu" role="button" aria-expanded="false" aria-controls="settingsSubmenu">
                Settings
            </a>
            <div class="collapse" id="settingsSubmenu">
                <nav class="nav flex-column ms-3">
                    <?php if (has_permission('8sAygcnqpOXP8aAAG7IAWI4Cg', $user_permissions)) { ?>
                        <a class="nav-link dropdown-toggle fw-normal" data-bs-toggle="collapse" href="#manageRoleSubmenu" role="button" aria-expanded="false" aria-controls="manageRoleSubmenu">
                        ...
                        <a class="nav-link dropdown-toggle fw-normal" data-bs-toggle="collapse" href="#managePermissionSubmenu" role="button" aria-expanded="false" aria-controls="managePermissionSubmenu">
                            Manage Permissions
                        </a>
