<div class="modal fade" id="customOfficeExportXLSXModal" tabindex="-1"
    aria-labelledby="customOfficeExportXLSXModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="customOfficeExportXLSXModalLabel">Custom Date Range by Office</h5>
            ...
            <div class="modal-body">
                <form method="POST" id="customOfficeFormXLSX"
                    ...
                    <button type="button" class="btn btn-primary" id="applyDateRangeXLSX">Download</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    const exportForm = document.getElementById('customOfficeFormXLSX');
    const applyButton = document.getElementById('applyDateRangeXLSX');
    ...
    if (applyButton) {
        applyButton.addEventListener('click', async () => {
            ...
            // Hide the modal
            const modal = document.getElementById('customOfficeExportXLSXModal');
            if (modal) {
