<div class="modal fade" id="customRangeExportXLSXModal" tabindex="-1" aria-labelledby="customRangeExportXLSXModalLabel"
    aria-hidden="true">
...
<script>
    const exportForm = document.getElementById('customRangeXLSX');
    ...
    if (applyButton) {
        applyButton.addEventListener('click', async () => {
            ...
            // Hide the modal
            const modal = document.getElementById('customRangeExportXLSXModal');
            if (modal) {
